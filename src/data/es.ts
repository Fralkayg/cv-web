  ...
  experience: [
    {
      ...
      endDate: null,
      bullets: [
        'Mantengo y mejoro aplicaciones empresariales críticas para el negocio, asegurando estabilidad y confiabilidad a largo plazo.',
        'Desarrollo e integro nuevas funcionalidades para responder a requisitos de negocio en evolución.',
        'Diagnostico y resuelvo defectos, problemas de rendimiento e incidentes mediante análisis de causa raíz y su remediación.',
        'Migro bases de código legadas en C++ a Scala, modernizando sistemas centrales mientras preservo la lógica de negocio y su funcionalidad.',
        'Utilizo herramientas asistidas por IA (principalmente Claude) para acelerar la depuración de código legado, refactorizar módulos complejos, generar cobertura de pruebas unitarias y producir documentación técnica, mejorando la velocidad de desarrollo y la mantenibilidad del código.',
      ],
