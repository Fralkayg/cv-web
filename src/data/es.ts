  ...
  experience: [
    {
      ...
      endDate: null,
      bullets: [
        'Mantuve y mejoré aplicaciones empresariales críticas para el negocio, asegurando estabilidad y confiabilidad a largo plazo.',
        'Desarrollé e integré nuevas funcionalidades para responder a requisitos de negocio en evolución.',
        'Diagnostiqué y resolví defectos, problemas de rendimiento e incidentes mediante análisis de causa raíz y su remediación.',
        'Migré bases de código legadas en C++ a Scala, modernizando sistemas centrales mientras preservé la lógica de negocio y su funcionalidad.',
        'Utilicé herramientas asistidas por IA (principalmente Claude) para acelerar la depuración de código legado, refactorizar módulos complejos, generar cobertura de pruebas unitarias y producir documentación técnica, mejorando la velocidad de desarrollo y la mantenibilidad del código.',
      ],
